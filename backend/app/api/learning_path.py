...
async def create_or_generate_path(
    ...
    try:
        ...
        return await LearningPathService.generate_or_get_learning_path(topic_id, req.user_id or "default-user", db)
...
async def get_topic_path(
    ...
    try:
        return await LearningPathService.generate_or_get_learning_path(topic_id, user_id, db)
    except Exception as e:
...
async def toggle_node(
    ...
    try:
        return await LearningPathService.toggle_node_completion(topic_id, user_id, node_id, db)
    except Exception as e:
